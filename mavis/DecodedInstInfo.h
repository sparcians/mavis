...
public:
    ...
    using OpInfoList = OperandInfo::ElementList; // For dabble::Instruction, remove after deprecation
...
private:
    ...
    //static inline bool
    //agree_(const OperandArray &arr, uint64_t bits, const std::string &context, const std::string &form_name)
    //{
    //    uint64_t arr_bits = 0;
    ...
    bool agree_opinfo_(const OperandInfo::ElementList &olist, uint64_t bits,
                       ...
                       InstMetaData::OperandTypes otype = InstMetaData::OperandTypes::NONE) const
    {
        ...
        for (const auto &opinfo : olist) {
            ...
            if (((otype == InstMetaData::OperandTypes::NONE) ||
                 (opinfo.operand_type == otype)) && ((oi_bit & bits) == 0)) {
                std::cerr << "EXTRACTION MISMATCH: Form '" << form_name << "'"
                          << ", context '" << context << "'"
...
public:
    ...
    uint64_t ext_itype = static_cast<std::underlying_type_t<ExtractedInstTypes>>(ExtractedInstTypes::NONE);
    ...
    DecodedInstructionInfo(const std::string &iname, const InstructionUniqueID uid,
        ...
        word_sources(extractor->getSourceOperTypeRegs(icode, meta, InstMetaData::OperandTypes::WORD)),
        word_dests(extractor->getDestOperTypeRegs(icode, meta, InstMetaData::OperandTypes::WORD)),
        word_operands(word_sources | word_dests),
        //word_oper_vals(extractor->getOperTypeList(icode, meta, InstMetaData::OperandTypes::WORD)),
        //word_source_vals(extractor->getSourceOperTypeList(icode, meta, InstMetaData::OperandTypes::WORD)),
        //word_dest_vals(extractor->getDestOperTypeList(icode, meta, InstMetaData::OperandTypes::WORD)),
        ...
        long_sources(extractor->getSourceOperTypeRegs(icode, meta, InstMetaData::OperandTypes::LONG)),
        long_dests(extractor->getDestOperTypeRegs(icode, meta, InstMetaData::OperandTypes::LONG)),
        long_operands(long_sources | long_dests),
        //long_oper_vals(extractor->getOperTypeList(icode, meta, InstMetaData::OperandTypes::LONG)),
        //long_source_vals(extractor->getSourceOperTypeList(icode, meta, InstMetaData::OperandTypes::LONG)),
        //long_dest_vals(extractor->getDestOperTypeList(icode, meta, InstMetaData::OperandTypes::LONG)),
        ...
        single_sources(extractor->getSourceOperTypeRegs(icode, meta, InstMetaData::OperandTypes::SINGLE)),
        single_dests(extractor->getDestOperTypeRegs(icode, meta, InstMetaData::OperandTypes::SINGLE)),
        single_operands(single_sources | single_dests),
        //single_oper_vals(extractor->getOperTypeList(icode, meta, InstMetaData::OperandTypes::SINGLE)),
        //single_source_vals(extractor->getSourceOperTypeList(icode, meta, InstMetaData::OperandTypes::SINGLE)),
        //single_dest_vals(extractor->getDestOperTypeList(icode, meta, InstMetaData::OperandTypes::SINGLE)),
        ...
        double_sources(extractor->getSourceOperTypeRegs(icode, meta, InstMetaData::OperandTypes::DOUBLE)),
        double_dests(extractor->getDestOperTypeRegs(icode, meta, InstMetaData::OperandTypes::DOUBLE)),
        double_operands(double_sources | double_dests),
        //double_oper_vals(extractor->getOperTypeList(icode, meta, InstMetaData::OperandTypes::DOUBLE)),
        //double_source_vals(extractor->getSourceOperTypeList(icode, meta, InstMetaData::OperandTypes::DOUBLE)),
        //double_dest_vals(extractor->getDestOperTypeList(icode, meta, InstMetaData::OperandTypes::DOUBLE)),
        ...
        quad_sources(extractor->getSourceOperTypeRegs(icode, meta, InstMetaData::OperandTypes::QUAD)),
        quad_dests(extractor->getDestOperTypeRegs(icode, meta, InstMetaData::OperandTypes::QUAD)),
        quad_operands(quad_sources | quad_dests),
        //quad_oper_vals(extractor->getOperTypeList(icode, meta, InstMetaData::OperandTypes::QUAD)),
        //quad_source_vals(extractor->getSourceOperTypeList(icode, meta, InstMetaData::OperandTypes::QUAD)),
        //quad_dest_vals(extractor->getDestOperTypeList(icode, meta, InstMetaData::OperandTypes::QUAD)),
        ...
        vector_sources(extractor->getSourceOperTypeRegs(icode, meta, InstMetaData::OperandTypes::VECTOR)),
        vector_dests(extractor->getDestOperTypeRegs(icode, meta, InstMetaData::OperandTypes::VECTOR)),
        ...
        // function(extractor->getFunction(icode))
    {
        ...
        if (icode != 0 ) {
            ...
            //for (uint32_t i = 0;
            //     i < static_cast<std::underlying_type_t<InstMetaData::OperandTypes>>(InstMetaData::OperandTypes::__N);
            //     ++i) {
            ...
            assert(agree_opinfo_(source_opinfo_list, word_sources, "word_sources", form_name, InstMetaData::OperandTypes::WORD));
            assert(agree_opinfo_(source_opinfo_list, long_sources, "long_sources", form_name, InstMetaData::OperandTypes::LONG));
            assert(agree_opinfo_(source_opinfo_list, single_sources, "single_sources", form_name, InstMetaData::OperandTypes::SINGLE));
            assert(agree_opinfo_(source_opinfo_list, double_sources, "double_sources", form_name, InstMetaData::OperandTypes::DOUBLE));
            assert(agree_opinfo_(source_opinfo_list, quad_sources, "quad_sources", form_name, InstMetaData::OperandTypes::QUAD));
            assert(agree_opinfo_(source_opinfo_list, vector_sources, "vector_sources", form_name, InstMetaData::OperandTypes::VECTOR));

            assert(agree_opinfo_(dest_opinfo_list, dests, "dests", form_name));
            assert(agree_opinfo_(dest_opinfo_list, word_dests, "word_dests", form_name, InstMetaData::OperandTypes::WORD));
            assert(agree_opinfo_(dest_opinfo_list, long_dests, "long_dests", form_name, InstMetaData::OperandTypes::LONG));
            assert(agree_opinfo_(dest_opinfo_list, single_dests, "single_dests", form_name, InstMetaData::OperandTypes::SINGLE));
            assert(agree_opinfo_(dest_opinfo_list, double_dests, "double_dests", form_name, InstMetaData::OperandTypes::DOUBLE));
            assert(agree_opinfo_(dest_opinfo_list, quad_dests, "quad_dests", form_name, InstMetaData::OperandTypes::QUAD));
            assert(agree_opinfo_(dest_opinfo_list, vector_dests, "vector_dests", form_name, InstMetaData::OperandTypes::VECTOR));
        }
#endif
        ...
        if (meta->isInstType(InstMetaData::InstructionTypes::JAL) ||
            ...
            if ((dests & link_regs) != 0) {
                ext_itype |= static_cast<std::underlying_type_t<ExtractedInstTypes>>(ExtractedInstTypes::CALL);
            }
            ...
            if ((sources & link_regs) != 0) {
                ...
                if ((sources & dests & link_regs) == 0) {
                    ext_itype |= static_cast<std::underlying_type_t<ExtractedInstTypes>>(ExtractedInstTypes::RETURN);
                }
            } else if (hasSourceReg_(sources)) {
                ext_itype |= static_cast<std::underlying_type_t<ExtractedInstTypes>>(ExtractedInstTypes::INDIRECT);
            }
        }
    }
