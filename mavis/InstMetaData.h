    ...
    class InstMetaData
    {
      ...
      private:
        ...
        static inline std::map<std::string, ISAExtensionIndex> isamap_{
            {"A", ISAExtensionIndex::A}, {"B", ISAExtensionIndex::B}, {"C", ISAExtensionIndex::C},
            {"D", ISAExtensionIndex::D}, {"F", ISAExtensionIndex::F}, {"G", ISAExtensionIndex::G},
            {"H", ISAExtensionIndex::H}, {"I", ISAExtensionIndex::I}, {"M", ISAExtensionIndex::M},
            {"Q", ISAExtensionIndex::Q}, {"V", ISAExtensionIndex::V}};
