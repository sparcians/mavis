 ...
 */
template<class TraceInfoType>
class ExtractorTraceInfo : public ExtractorIF
{
private:
    // TODO: Move this to a central place (shared by DecodedInstInfo, ExtractorDirectInfo, and ExtractorTraceInfo)
...
public:
    explicit ExtractorTraceInfo(const TraceInfoType &tinfo) :
        tinfo_(tinfo)
    {}
    ...
    //RegListType getSourceOperTypeList(const Opcode, const InstMetaData::PtrType &, InstMetaData::OperandTypes,
    ...
    // TODO: Finish this
    uint64_t getDestOperTypeRegs(const Opcode,
                                 const InstMetaData::PtrType &meta, InstMetaData::OperandTypes kind) const override
    {
        return 0;
    }
    ...
    // Default implementation returns empty list
    //RegListType getDestOperTypeList(const Opcode, const InstMetaData::PtrType &, InstMetaData::OperandTypes,
    //                                bool suppress_x0 = false) const override
    //{
    //    return {};
    //}
                                     ...
                                     bool suppress_x0 = false) const override
    {
        ...
        for (const auto& reg : source_list) {
            olist.addElement(InstMetaData::OperandFieldID::NONE, InstMetaData::OperandTypes::NONE,
                               reg, false);
        }
        return olist;
    }
