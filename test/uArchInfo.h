...
#include "json.hpp"
    ...
    public:
         ...
         */
        explicit uArchInfo(const nlohmann::json& jobj)
        {
            parse_(jobj);
        }
        ...
        void update(const nlohmann::json& jobj) {
            // TODO: identical to constructor(jobj) for now, but we may want to provide update restrictions
            parse_(jobj);
        }
        ...
        IssueTarget getIssueTarget() const {
            return issue_target_;
        }
        ...
        bool isROBGrpStart() const {
            return rob_grp_start_;
        }

        bool isROBGrpEnd() const {
            return rob_grp_end_;
        }
