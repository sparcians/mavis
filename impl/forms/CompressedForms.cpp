...
const FieldsType Form_C0::opcode_fields {
    Form_C0::fields[Form_C0::idType::OPCODE],
...
const FieldsType Form_C1::opcode_fields {
    Form_C1::fields[Form_C1::idType::OPCODE],
    Form_C1::fields[Form_C1::idType::FUNC3],
    Form_C1::fields[Form_C1::idType::FUNC2],
    Form_C1::fields[Form_C1::idType::FUNC2B],
    Form_C1::fields[Form_C1::idType::FUNC1],
};
...
const FieldsType Form_C2::fields {
    Field("func3", 13, 3),
    Field("func1", 12, 1),
...
const FieldsType Form_C2::opcode_fields {
    Form_C2::fields[Form_C2::idType::OPCODE],
...
const FieldsType Form_C2_sp_store::fields {
    Field("func3", 13, 3),
    Field("imm", 7, 6),
    Field("rs2", 2, 5),
    Field("opcode", 0, 2)
...
const FieldsType Form_CA::fields {
    Field("func6", 10, 6),
    Field("rs1", 7, 3),
    Field("rd", 7, 3),
    Field("func2", 5, 2),
...
const FieldsType Form_CA::opcode_fields {
    Form_CA::fields[Form_CA::idType::OPCODE],
...
const FieldsType Form_CB::fields {
    Field("func3", 13, 3),
    Field("imm3", 10, 3),
    Field("rs1", 7, 3),
    Field("imm5", 2, 5),
...
const FieldsType Form_CB::opcode_fields {
    Form_CB::fields[Form_CB::idType::OPCODE],
...
const FieldsType Form_CI::fields {
    Field("func3", 13, 3),
    Field("imm1", 12, 1),
    Field("rs1", 7, 5),
    Field("rd", 7, 5),
...
const FieldsType Form_CI::opcode_fields {
    Form_CI::fields[Form_CI::idType::OPCODE],
...
const FieldsType Form_CI_rD_only::fields {
    Field("func3", 13, 3),
    Field("imm1", 12, 1),
    Field("rd", 7, 5),
    Field("imm5", 2, 5),
...
const FieldsType Form_CIW::fields {
    Field("func3", 13, 3),
    Field("imm8", 5, 8),
    Field("rd", 2, 3),
    Field("opcode", 0, 2)
...
const FieldsType Form_CIW::opcode_fields {
    Form_CIW::fields[Form_CIW::idType::OPCODE],
...
const FieldsType Form_CIX::opcode_fields {
    Form_CIX::fields[Form_CIX::idType::OPCODE],
...
const FieldsType Form_CJ::fields {
    Field("func3", 13, 3),
    Field("imm11", 2, 11),
    Field("opcode", 0, 2)
};
...
const FieldsType Form_CJ::opcode_fields {
    Form_CJ::fields[Form_CJ::idType::OPCODE],
...
const FieldsType Form_CJR::fields {
    Field("func4", 12, 4),
    Field("rs1", 7, 5),
    Field("rs2", 2, 5),
    Field("opcode", 0, 2)
...
const FieldsType Form_CJR::opcode_fields {
    Form_CJR::fields[Form_CJR::idType::OPCODE],
