...
const FieldsType Form_V::opcode_fields {
    Form_V::fields[Form_V::idType::OPCODE],
    Form_V::fields[Form_V::idType::FUNC3A],
    Form_V::fields[Form_V::idType::FUNC1A],
    Form_V::fields[Form_V::idType::FUNC1B],
    Form_V::fields[Form_V::idType::FUNC1C],
    Form_V::fields[Form_V::idType::FUNC3B]
};
...
const FieldsType Form_VF_mem::opcode_fields {
    Form_VF_mem::fields[Form_VF_mem::idType::OPCODE],
...
const FieldsType Form_V_vsetvli::fields {
    Field("func1", 31, 1),
    Field("imm11", 20, 11),
    Field("rs1", 15, 5),
    Field("func3", 12, 3),
...
const FieldsType Form_V_vsetivli::fields {
    Field("func2", 30, 2),
    Field("imm10", 20, 10),
    Field("avl", 15, 5),
    Field("func3", 12, 3),
...
const FieldsType Form_V_vsetvl::fields {
    Field("func7", 25, 7),
    Field("rs2", 20, 5),
    Field("rs1", 15, 5),
    Field("func3", 12, 3),
...
const FieldsType Form_V_uimm6::opcode_fields {
    Form_V_uimm6::fields[Form_V_uimm6::idType::OPCODE],
