...
namespace mavis
{
    ...
    const ExtractorIF::PtrType & ExtractorRegistry::getExtractor(const std::string & fname)
    {
        static const std::map<std::string, ExtractorIF::PtrType> EXTRACTOR_REGISTRY = {
            ...
            {Form_CMPP_push::name,               std::make_shared<Extractor<Form_CMPP_push>>()         },
            {Form_CMPP_popretz::name,            std::make_shared<Extractor<Form_CMPP_popretz>>()      },
            {Form_CMMV_mva01s::name,             std::make_shared<Extractor<Form_CMMV_mva01s>>()       },
            {Form_CMMV_mvsa01::name,             std::make_shared<Extractor<Form_CMMV_mvsa01>>()       },
            {Form_CMJT::name,                    std::make_shared<Extractor<Form_CMJT>>()              },
            ...
            {Form_Rfloat_fli_h::name,            std::make_shared<Extractor<Form_Rfloat_fli_h>>()      },
            {Form_Rfloat_fli_s::name,            std::make_shared<Extractor<Form_Rfloat_fli_s>>()      },
            {Form_Rfloat_fli_d::name,            std::make_shared<Extractor<Form_Rfloat_fli_d>>()      },
            {Form_Rfloat_fli_q::name,            std::make_shared<Extractor<Form_Rfloat_fli_q>>()      },
